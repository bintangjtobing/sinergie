...
<div class="card">
    <div class="card-title">
        ...
        <a href="#additem">
            <button type="button" class="btn btn-primary btn-flat btn-addon m-b-10 m-l-5 float-right" data-toggle="modal" data-target="#additem">
