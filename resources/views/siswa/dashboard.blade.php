            ...
            <div class="nano-content">
                ...
                <ul>
                    ...
                    <div class="alert alert-info">
                        <span style="font-size: 1.2em; color: green;"><i class="fas fa-check-circle"></i></span>Active
                        <br>
                        <p class="palert">Kamu berlangganan paket
                            <strong>{{Auth::guard('murid')->user()->paket}}</strong></p>
                    </div>
                    <li title="Logout" data-toggle="tooltip" data-placement="right"><a href="/siswa/dashboard/logout"><i
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="float-right">
                        <ul>
                            <li class="header-icon dib"><span
                                    class="user-avatar">{{Auth::guard('murid')->user()->nama_murid}} <i
                                ...
                                <div class="drop-down dropdown-profile">
                                    <div class="dropdown-content-body">
                                        <ul>
                                            ...
                                            <li><a href="/siswa/{{Auth::guard('murid')->user()->id_murid}}/setting"><i
                                                        class="ti-settings"></i> <span>Setting</span></a></li>

                                            <li><a href="#"><i class="ti-lock"></i> <span>Lock Screen</span></a></li>
                                            <li><a href="/siswa/dashboard/logout"><i class="ti-power-off"></i>
