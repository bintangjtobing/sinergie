                        ...
                        @if(!$data_kelas->isEmpty())
                          @foreach($data_kelas as $dt_kelas)
                            <tr>
                              ...
                              <td colspan="2"><a href="/kelas/{{$dt_kelas->kelas_id}}/delete" title="Delete Kelas" data-toggle="tooltip" data-placement="top"><button class="btn btn-rounded btn-danger" data-toggle="modal"><span class="fas fa-trash-alt" style="font-size:12px;"></span></button></a></td>
                            </tr>
                              @endforeach
                                @else
