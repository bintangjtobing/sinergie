...
<meta name="author" content="Bintang Jeremia Tobing">
    ...
    <body>
            ...
            <div class="nano">
                <div class="nano-content">
                    ...
                    <ul>
                        ...
                        <li title="Dashboard" data-toggle="tooltip" data-placement="right"><a href="/dashboard"><i class="ti-home"></i> Dashboard</a></li>
                        ...
                        <li><a class="sidebar-sub-toggle"><i class="ti-panel"></i>  Komponen Kelas  <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                            <ul>
                        ...
                        <li title="Logout" data-toggle="tooltip" data-placement="right"><a href="/logout"><i class="ti-close"></i> Logout</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <!-- Modal -->
        <div class="modal fade" id="modalPurchase" tabindex="-1" role="dialog" aria-labelledby="modalPurchase" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        We know that our application still requires broader and more complex developments, for that we always innovate in developing our system so that the clients we serve are satisfied with our system. If you are willing to help in our development, you can contact us in developing the idea at <a href="mailto:support@starwhisper.id">support@starwhisper.id</a><br>
                        <hr>
                        <h3>Purchase this App.</h3>
                        And for the demo application, you can only see demo data, and if you want to use all the features, please pay off your payment and immediately confirm to the email <a href="mailto:billing@starwhisper.id">billing@starwhisper.id</a>
                </div>
