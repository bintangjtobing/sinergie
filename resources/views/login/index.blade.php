...
<body>
	...
	<div class="limiter">
		<div class="container-login100"
			style="background-image: url(https://res.cloudinary.com/starwhisper/image/upload/v1571112499/web/webpublic-min_vc9xta.jpg);">
			<div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41">
					Account Login
				</span>
				@if(session('sukses'))
				<div class="alert alert-success" role="alert">BERHASIL! Sekarang kamu sudah menjadi anggota murid dari
					Bimbel Sinergie</div>
				...
				<form action="/postlogin" method="POST" class="login100-form validate-form p-b-33 p-t-5">
					...
					<div class="container-login100-form-btn m-t-32">
						...
						<a href="https://sinergiecollege.com" class="login100-form-btn"><i class="fas fa-home mr-1"></i>
							Home</a>
